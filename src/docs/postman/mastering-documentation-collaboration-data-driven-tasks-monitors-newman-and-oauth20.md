---
title: "02: Mastering Documentation, Collaboration, Data Driven Tasks, Monitors, Newman & OAuth2.0"
date: "2025-12-04"
parent: "postman"
order: 2
author: Noyon Rahman
...
![postman-banner-image](https://i.ibb.co/CQBx5WY/postman-workshop-day-2.png)
...
pm.test(
  "is should validate the response body with the collection variables",
  () => {
