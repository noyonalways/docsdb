...
![YAML Banner](https://i.ibb.co.com/R6CFG73/yaml-github-banner.png)
...
- [Basic YAML Syntax](/docs/yaml/basic-yaml-syntax)
- [YAML Data types](/docs/yaml/yaml-data-types)
- [YAML Styles](/docs/yaml/yaml-styles)
- [YAML Mapping](/docs/yaml/yaml-mapping)
- [YAML Sequences](/docs/yaml/yaml-sequences)
- [YAML Scalars](/docs/yaml/yaml-scalars)
- [YAML Structure](/docs/yaml/yaml-structure)
- [YAML Comments](/docs/yaml/yaml-comments)
- [YAML Anchors](/docs/yaml/yaml-anchors)
- [YAML Tags](/docs/yaml/yaml-tags)
